...
if(isset($_POST['submit'])){
	$stat_skripsi = mysqli_real_escape_string($conn, $_POST['stat_skripsi']);
	$nilai_skripsi = mysqli_escape_string($conn, $_POST['nilai_skripsi']);
	$lama_studi = mysqli_escape_string($conn, $_POST['lama_studi']);
	$tgl_sidang = mysqli_escape_string($conn, $_POST['tgl_sidang']);
	$scan_berita = $_POST['scan_berita'];
	$lokasi_file = $_FILES['scan_berita']['tmp_name'];
	$scan_berita = $_FILES['scan_berita']['name'];
	$direktory = "upload/$scan_berita";


	$query = "SELECT * FROM tb_skripsi WHERE stat_skripsi ='stat_skripsi' && nilai_skripsi = 'nilai_skripsi' && lama_studi = 'lama_studi' && tgl_sidang = 'tgl_sidang' && scan_berita = 'scan_berita'&& nim = 'nim' " ;
	...
	if(mysqli_num_rows($result)){
        ...
        $insert = " INSERT INTO tb_skripsi(stat_skripsi, nilai_skripsi, lama_Studi, tgl_sidang, scan_berita, nim) VALUES ('$stat_skripsi', '$nilai_skripsi', '$lama_studi', '$tgl_sidang', '$scan_berita', '$nim')";
...
<div class="dashboard">
	...
	<main class="content-wrap">
		<header class="content-head">
			<h1 style="margin-bottom: 20px;">SKRIPSI</h1>
		</header>
        <div class="content">
			<div class="">
					...
					<div class="card-body">
						<form action="" method="POST" enctype="multipart/form-data">
							<div class="form-group">
								...
								<select class="form-control" id="stat_skripsi" name="stat_skripsi">
									<option value="">Pilih Status</option>
                                    <option value="lulus">Lulus</option>
                                    <option value="tidak lulus">Tidak Lulus</option>
								</select>
								<small class="form-text text-danger" id="stat_skripsi_error"></small>
							</div>
							<br>
                            <div class="form-group">
							<label for="nilai_skripsi">Nilai Skripsi</label>
								<select class="form-control" id="nilai_skripsi" name="nilai_skripsi">
								...
								<small class="form-text text-danger" id="nilai_skripsi_error"></small>
							</div>
							<br>
                            <div class="form-group">
								...
								<small class="form-text text-danger" id="lama_studi_error"></small>
							</div>
							<br>
                            <div class="form-group">
								<label for="tgl_sidang">Tanggal Sidang</label>
								<input type="date" class="form-control" name="tgl_sidang" id="tgl_sidang">
								<small class="form-text text-danger" id="tgl_sidang_error"></small>
							</div>
							<br>
                            <div class="form-group">
                                <div class="mb-3">
                                    <label for="scan_berita">Scan Berita Acara</label>
                                    <input class="form-control" type="file" id="scan_berita" name="scan_berita">
                                </div>
                            </div>
                            <br>
