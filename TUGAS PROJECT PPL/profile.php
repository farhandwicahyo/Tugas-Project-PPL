...
if(isset($_POST['submit'])){
	...
	$query = "SELECT * FROM tb_profile_user WHERE nama ='nama' && nim = 'nim' && angkatan = 'angkatan' && provinsi = 'provinsi' && kota = 'kota' && email = 'email' && nohp = 'nohp' " ;
	...
	if(mysqli_num_rows($result)){
        ...
        $insert = " INSERT INTO tb_profile_user (nama, nim, angkatan, provinsi, kota, email, nohp) VALUES ('$nama', '$nim', '$angkatan', '$provinsi', '$kota', '$email', '$nohp')";
