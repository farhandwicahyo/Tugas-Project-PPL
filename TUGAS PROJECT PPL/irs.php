...
if(isset($_POST['submit'])){
	...
	$scan_irs = $_POST['scan_irs'];
	$lokasi_file = $_FILES['scan_irs']['tmp_name'];
	$scan_irs = $_FILES['scan_irs']['name'];
	$direktory = "upload/$scan_irs";



	$query = "SELECT * FROM tb_irs WHERE semester ='semester' && jmlh_sks = 'jmlh_sks' && scan_irs = 'scan_irs' && nim = 'nim' " ;
	...
	if(mysqli_num_rows($result)){
        ...
        $insert = " INSERT INTO tb_irs(semester, jmlh_sks, scan_irs, nim) VALUES ('$semester', '$jmlh_sks', '$scan_irs', '$nim')";
...
<div class="dashboard">
	...
	<main class="content-wrap">
		<header class="content-head">
			<h1 style="margin-bottom: 20px;">BUAT IRS</h1>
		</header>
        <div class="content">
			<div class="">
						...
						<form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="mb-3" style="margin-top: 20px;">
                                    ...
                                    <input class="form-control" type="file" id="scan_irs" name="scan_irs">
                                </div>
                            </div>
                            <br>
