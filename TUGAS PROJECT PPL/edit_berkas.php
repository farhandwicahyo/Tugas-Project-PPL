...
if(isset($_POST['submit'])){
	...
	$status_mhs = mysqli_escape_string($conn, $_POST['status_mhs']);

    
    $query = "UPDATE tb_profile_user SET nama='" . $nama . "', nim='" . $nim . "', angkatan='" . $angkatan . "', provinsi='" . $provinsi . "', kota='" . $kota . "' , status_mhs='" . $status_mhs . "' WHERE id=" . $id;
	$result = mysqli_query($conn, $query);
    
    header('location:verif_berkas_mhs.php');
} else {
...
<div class="dashboard">
	...
	<main class="content-wrap">
		<header class="content-head">
			<h1 style="margin-bottom: 20px;">Edit Berkas Mahasiswa</h1>
		</header>
		...
		<div class="content">
			<div class="">
				<div class="card shadow p-3 mb-5 bg-body rounded">
					...
					<div class="card-body">
						<form id ="myform" method="POST" onsubmit="return submitForm()" name="form">
							...
							<br>
							<div class="form-group">
								<label for="status_mhs">Pilih Status Mahasiswa</label>
								<select class="form-control" id="status_mhs" name="status_mhs">
							...
							<br>
							<!--a href="verif_berkas_mhs.php" 	button type="submit" name="submit" value="submit" class="btn btn-primary" onclick=''>Submit</button> -->
							<!--<a href="verif_berkas_mhs.php" onclick="document.getElementById('myform').submit();">Submit</a> -->
