		...
		<div class="content shadow p-3 mb-5 bg-body rounded">
			<section class="info-boxes">
				...
				<div class="info-box">
					...
					<div class="box-content">
						<span class="big" style="background-color: aquamarine;">AKTIF</span>
						Status Mahasiswa
					</div>
				</div>
				...
				<div class="info-box">
					...
					<div class="box-content">
						<span class="big" style="font-size: 1.3em;">Michael Arga S S.Kom</span>
						Dosen Wali
					</div>
				</div>
