...
if(isset($_POST['submit'])){
	...
	$query = "SELECT * FROM tb_profile_user WHERE nama ='nama' && provinsi = 'provinsi' && kota = 'kota' && email = 'email' && nohp = 'nohp' " ;
	...
	if(mysqli_num_rows($result)){
        ...
        $insert = " INSERT INTO tb_profile_admin(nama, provinsi, kota, email, nohp) VALUES ('$nama', '$provinsi', '$kota', '$email', '$nohp')";
