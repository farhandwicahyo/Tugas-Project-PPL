...
<div class="dashboard">
	...
	<main class="content-wrap">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
				<?php
					$query = "SELECT * FROM tb_skripsi as s INNER JOIN tb_profile_user as m ON s.nim = m.nim";
					...
					while ($row = $result->fetch_assoc()) {
						...
						echo "<td>".$row['stat_skripsi']."</td>";
						echo "<td>".$row['nilai_skripsi']."</td>";
						echo "<td>".$row['lama_studi']."</td>";
						echo "<td>".$row['tgl_sidang']."</td>";
						echo '<td><a href="http://localhost:/Tugas%20Project%20PPL/upload/' .$row['scan_berita'] . '">' .$row
						['scan_berita'].'</a></td>';
						echo "</tr>";
						$i++;
					}
