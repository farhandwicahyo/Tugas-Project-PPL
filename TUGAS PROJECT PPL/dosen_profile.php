...
if(isset($_POST['submit'])){
	...
	$query = "SELECT * FROM tb_profile_dosen WHERE nama ='nama' && nid = 'nid' && provinsi = 'provinsi' && kota = 'kota' && email = 'email' && nohp = 'nohp' " ;
	...
	if(mysqli_num_rows($result)){
        ...
        $insert = " INSERT INTO tb_profile_dosen (nama, nid, provinsi, kota, email, nohp) VALUES ('$nama', '$nid', '$provinsi', '$kota', '$email', '$nohp')";
        mysqli_query($conn, $insert);
        header('location:dosen_profile.php');
    }
}
	...
	<header class="menu-wrap">
		...
		<nav>
			<section class="dicover">
                <a href="dosen_page.php" style="text-decoration:30px ;">
				<h3>DASHBOARD</h3>
                </a>
					...
					<div class="card-body">
						<form method="POST" onsubmit="return submitForm()" name="form">
                            ...
                            <div class="form-group">
								...
								<small class="form-text text-danger" id="nid_error"></small>
                                <small class="form-text text-success" id="nim_success" style="display: none">NID tervalidasi</small>
							</div>
							<br>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<small class="form-text text-danger" id="kota_error"></small>
							</div>
							<br>
							<div class="form-group">
